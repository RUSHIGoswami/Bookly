...
<body>
   ...
   <section class="home">
      ...
      <div class="content">
         ...
         <p>“I pronounce after all there is no pleasure like perusing!”- Jane Austen, Pride, and Prejudice.</p>
      ...
      <div class="box-container">
         ...
         ?>
               <form action="" method="post" class="box">
                  <img class="image" src="uploaded_img/<?php echo $fetch_products['image']; ?>" style="width: 198px; height:300px" alt="">
                  <div class="name">
                     <marquee behavior="" direction=""><?php echo $fetch_products['name']; ?></marquee>
                  </div>
   ...
   <section class="home-contact">
      ...
      <div class="content">
         ...
         <p>Feel free to ask us by pressing button below.</p>
